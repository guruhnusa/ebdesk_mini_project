...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/analytic.svg
  SvgGenImage get analytic => const SvgGenImage('assets/icons/analytic.svg');
  ...
  /// File path: assets/icons/flag_.svg
  SvgGenImage get flag => const SvgGenImage('assets/icons/flag_.svg');

  /// File path: assets/icons/moon_.svg
  SvgGenImage get moon => const SvgGenImage('assets/icons/moon_.svg');
  ...
  /// File path: assets/icons/work_log.svg
  SvgGenImage get workLog => const SvgGenImage('assets/icons/work_log.svg');
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [reward];
}
